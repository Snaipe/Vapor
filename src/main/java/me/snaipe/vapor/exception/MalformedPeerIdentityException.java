 ...
 */
package me.snaipe.vapor.exception;

public class MalformedPeerIdentityException extends RuntimeException {
	private static final long serialVersionUID = 1L;

	public MalformedPeerIdentityException(String identity) {
		super("\"" + identity + "\" is not a valid peer_id string. Valid peer_id strings are 20 bytes (or less) long ASCII strings only.");
	}
